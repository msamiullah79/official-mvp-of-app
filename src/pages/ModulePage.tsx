...
import { getYear } from "@/data/curriculumData";
...
const ModulePage = () => {
  ...
  if (!year) {
    return (
      <div className="p-6 text-center text-muted-foreground">Year not found.</div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-foreground mb-1">{year.name}</h1>
      <p className="text-muted-foreground mb-8">Select a module to practice.</p>
